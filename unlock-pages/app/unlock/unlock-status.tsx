...
// This standalone build has no "/" of its own worth linking to (the whole
// site is this one page) — "Return home" points at the real PRIME-BOT
// site instead. Set at build time; falls back to the Railway dashboard
// domain if unset.
const MAIN_SITE_URL = process.env.NEXT_PUBLIC_MAIN_SITE_URL || 'https://dash-production-c237.up.railway.app'
  ...
  return (
    <main className="pb-page px-6 py-16">
      <div className="mx-auto max-w-xl space-y-8">
        ...
        <a className="pb-btn-secondary inline-flex" href={MAIN_SITE_URL}>
          Return home
        </a>
      </div>
    </main>
