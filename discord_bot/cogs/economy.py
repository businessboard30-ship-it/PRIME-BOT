...
class EconomyCog(GuildOnlyCog):
    ...
    @app_commands.command(name="work", description="Work a shift for currency")
    @app_commands.guild_only()
    ...
    @app_commands.command(name="leaderboard-economy", description="Show this server's richest members")
    @app_commands.guild_only()
    async def leaderboard_economy(self, interaction: discord.Interaction):
        await self.send_leaderboard(interaction)

    # ── minigames ────────────────────────────────────────────────────────
    @app_commands.command(name="coinflip", description="Bet currency on a coin flip")
    @app_commands.guild_only()
    ...
    @app_commands.command(name="vote", description="Vote for the bot for a currency bonus")
    @app_commands.guild_only()
    ...
    @app_commands.command(name="watchad", description="View a sponsor message for a currency bonus")
    @app_commands.guild_only()
