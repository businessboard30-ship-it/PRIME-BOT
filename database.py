...
class Database:
    ...
    async def set_leveling_config(self, guild_id: int, clone_id: Optional[int] = None, **fields) -> None:
        ...
        xp_rate, wizard_channel_id, wizard_message_id, wizard_invoker_id.
        Upserts, same pattern as set_welcome_config."""
        ...
        async with pool.acquire() as conn:
            await conn.execute(
                ...
                INSERT INTO discord_leveling_config
                    (guild_id, clone_id, announce_channel_id, announce_auto_created, xp_rate,
                     wizard_channel_id, wizard_message_id, wizard_invoker_id, updated_at)
                VALUES ($1, $2, $3, $4, $5, $6, $7, $8, NOW())
                ON CONFLICT (guild_id, (COALESCE(clone_id, -1))) DO UPDATE SET
                    announce_channel_id = $3, announce_auto_created = $4, xp_rate = $5,
